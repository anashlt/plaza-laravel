          ...
          <div class="col-md-8">
            <form action="/search">
              <div class="input-group input-group-lg mb-3">
                ...
                <input type="text" class="typeahead form-control bg-white w-50" id="search" name="q" placeholder="Search our database of ads..." aria-label="keyword" aria-describedby="basic-addon1" autocomplete="off">
                <div class="input-group-prepend">
